        ...
        <section id="contact" className="w-full   text-[#8892b0]">
            <div className="max-w-5xl w-full h-full mx-auto px-6 py-20 flex flex-col justify-center items-center">
                ...
                <form className="flex flex-col max-w-xl w-full mx-auto my-8">
                    <input className="mb-4 p-2 bg-[#ccd6f6]" type="text" placeholder="Name" />
                    <input className="mb-4 p-2 bg-[#ccd6f6]" type="text" placeholder="Email" />
                    <textarea className="p-2 bg-[#ccd6f6]" name="message" id="message" cols={30} rows={8} placeholder="Message"></textarea>
