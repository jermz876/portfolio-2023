...
const Contact = () => {
    return (
        <section id="contact" className="w-full   text-black">
            <motion.div
            ...
            >
                <h2 className="text-3xl md:text-4xl font-bold text-white border-b-4 border-b-blue-500  max-w-fit mb-10 ">Get In Touch</h2>
